...
const Navbar = () => (
  <header className="sticky top-0 z-30 bg-midnight/70 backdrop-blur-xl border-b border-white/5">
    <nav className="px-6 sm:px-10 lg:px-16 py-5 flex items-center justify-between">
      ...
      <a
        href="#contact"
        className="hidden sm:inline-flex items-center gap-2 rounded-full bg-electric px-5 py-2 text-sm font-semibold text-white shadow-glow transition hover:bg-electric/90"
      >
        Book Service
      </a>
    </nav>
